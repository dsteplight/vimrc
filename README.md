dsteplight's vimrc
============
Author: Tsung-Hsiang (Sean) Chang <dsteplight@dsteplight.tw>
...
Use curl (for Mac OS X):
     ...
     curl -o - https://raw.github.com/dsteplight/vimrc/master/auto-install.sh | sh

or wget (for most UNIX platforms):

     wget -O - https://raw.github.com/dsteplight/vimrc/master/auto-install.sh | sh
...
1. Check out from github
        ...
        git clone git://github.com/dsteplight/vimrc.git ~/.vim
        cd ~/.vim
...
1. Check out from github
        ...
        git clone git://github.com/dsteplight/vimrc.git vimfiles
        git submodule update --init
...
![My Vim Visual Cheat Sheet](http://people.csail.mit.edu/dsteplight/vim/vim-cheat-sheet-en.png "My Vim Visual Cheat Sheet")

* [Vim Visual Cheat Sheet (PNG)](http://people.csail.mit.edu/dsteplight/vim/vim-cheat-sheet-en.png)
* [Vim Visual Cheat Sheet (PDF)](http://people.csail.mit.edu/dsteplight/vim/vim-cheat-sheet-en.pdf)
* [Vim入門圖解 Chinese Ver. (PNG)](http://blog.dsteplight.tw/wp-content/uploads/2009/12/vim-cheat-sheet-full.png)
* [Vim入門圖解 Chinese Ver. (PDF)](http://blog.dsteplight.tw/wp-content/uploads/2009/12/dsteplight-vim-cheat-sheet-full.pdf)
